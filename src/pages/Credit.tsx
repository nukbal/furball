...
export default function Credit() {
  ...
  return (
    <div class="max-h-screen py-6 px-12 overflow-y-auto text-right dark:text-gray-300" data-tauri-drag-region>
...
export function CreditButton() {
  ...
  const isOn = () => mode() === 'credit';

  return (
    <Switch>
      <Match when={isOn()}>
        <button class="absolute top-1 left-2 p-1 rounded-lg hover:bg-gray-700" onClick={handleBack}>
          <ChevronLeft class="w-6 h-6" />
        </button>
      </Match>
      <Match when={!isOn()}>
        <button class="absolute bottom-2 right-2" onClick={handleClick}>
          <IconBase
            class="w-4 h-4 opacity-10"
